...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ([
            ...
            ['base_font_size', '16px', 'theme', 'text'],
            ['button_font_size', '16px', 'theme', 'text'],
            ['h1_font_size', '24px', 'theme', 'text'],
            ['h2_font_size', '22px', 'theme', 'text'],
            ['h3_font_size', '20px', 'theme', 'text'],
            ['h4_font_size', '18px', 'theme', 'text'],
            ['button_radius', '10px', 'theme', 'text'],
            ['container_width', '1200px', 'theme', 'text'],
            ['base_font_size_mobile', '15px', 'theme', 'text'],
            ['button_font_size_mobile', '15px', 'theme', 'text'],
            ['h1_font_size_mobile', '22px', 'theme', 'text'],
            ['h2_font_size_mobile', '20px', 'theme', 'text'],
            ['h3_font_size_mobile', '18px', 'theme', 'text'],
            ['h4_font_size_mobile', '16px', 'theme', 'text'],
            ['button_radius_mobile', '10px', 'theme', 'text'],
            ['container_width_mobile', '343px', 'theme', 'text'],
