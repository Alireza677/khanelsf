...
abstract class AbstractProductBlock extends AbstractBlock implements BlockNormalizer
{
    ...
    public function filamentSchema(string $context): array
    {
        if ($context !== HeroBlock::CONTEXT_TEMPLATE) {
            throw new InvalidArgumentException("Product block [{$this->key()}] is only available in the template editor.");
        }
