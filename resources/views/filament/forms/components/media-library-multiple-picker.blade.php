...
<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    ...
    >
        ...
        <template x-teleport="body">
            <div x-cloak x-show="open" x-transition.opacity style="display: none" class="cms-modal-layer flex items-center justify-center overflow-hidden p-4">
                <div class="cms-modal-backdrop bg-gray-950/60" style="background-color: rgba(2, 6, 23, 0.78); backdrop-filter: blur(2px)" aria-hidden="true"></div>
                <div x-on:click.outside="open = false" style="height: calc(100dvh - 2rem); max-height: calc(100dvh - 2rem)" class="cms-modal-panel flex h-[calc(100dvh-2rem)] max-h-[calc(100dvh-2rem)] w-full max-w-5xl flex-col overflow-hidden rounded-xl bg-white shadow-xl dark:bg-gray-900">
